...
interface DrawerEditProductProps {
    isOpen: boolean
    onClose: () => void
...
export function DrawerEditProduct({
    isOpen,
    onClose,
    product: productEdit,
}: DrawerEditProductProps) {
    ...
    useEffect(() => {
        ...
        setValue('amount', productEdit.amount)
        setValue('cod_product', productEdit.cod_product)
        setValue('image1', productEdit.images[0])
        setValue('image2', productEdit.images[1])
        setValue('image3', productEdit.images[2])
        setValue('available', productEdit.available)
        setValue('showItem', productEdit.showItem)
    }, [productEdit])
    ...
    async function handleCreateProduct(data: ProductFormData) {
        ...
        await updateProduct({ id: productEdit.id, product })
    }
